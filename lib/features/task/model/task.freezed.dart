...
class _$_Task extends _Task {
  ...
  @override
  String toString() {
    return 'Task(id: $id, name: $name, amount: $amount, headerImagePath: $headerImagePath, description: $description, type: $type, unit: $unit, dayCount: $dayCount, categoryId: $categoryId, visible: $visible, createdAt: $createdAt)';
  }
...
abstract class _Task extends Task {
  const factory _Task(
      ...
      final int? categoryId,
      final bool visible,
      final DateTime? createdAt}) = _$_Task;
