...
void _categorySerialize(
  ...
  writer.writeLongList(offsets[5], object.taskIds);
...
Category _categoryDeserialize(
  ...
  final object = Category(
    ...
    taskIds: reader.readLongList(offsets[5]) ?? [],
    visible: reader.readBool(offsets[6]),
  );
  return object;
}
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'taskIds',
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'taskIds',
        0,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'taskIds',
        0,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> taskIdsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> visibleEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'visible',
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByVisible() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visible', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByVisibleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByVisible() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visible', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByVisibleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visible', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByTaskIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'taskIds');
    });
  }

  QueryBuilder<Category, Category, QDistinct> distinctByVisible() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, List<int>, QQueryOperations> taskIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'taskIds');
    });
  }

  QueryBuilder<Category, bool, QQueryOperations> visibleProperty() {
    return QueryBuilder.apply(this, (query) {
